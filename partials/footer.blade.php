                ...
                <div class="copyright">
                    <div class="container">
                        ...
                        <div class="col-sm-6 col-xs-12 pull-left">
                           <p>&copy; {{ short_description(Theme::place('title'),80) }} {{date('Y')}} All Right Reserved. Powered by <a class="nodecoration" target="_blank" href="http://jarvis-store.com">Jarvis Store</a></p>
                       </div>
                    </div>
                </div>
            </footer>
