            ...
            {{Form::open(array('url'=>'member','method'=>'post','class'=>'form-horizontal'))}}
				...
				<div class="form-group">
					<div class="col-lg-offset-2 col-lg-10 col-xs-offset-1">
						<div class="checkbox">
							<input name="readme" value="1" type="checkbox"> Saya telah membaca dan menyetujui <a href="{{url('service')}}" target="_blank"><b class="privacy">Syarat & Ketentuan</b></a> yang berlaku di website ini.
						</div>
					</div>
				</div>
				<div class="form-group">
