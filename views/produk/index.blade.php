                        ...
                        <div id="center_column" class="col-lg-9 col-xs-12 col-sm-8">
                            <div class="product-list col-xs-12">
                                <div class="top-list">
                                    ...
                                    <ul class="btn-thumb">
                                        <li><label class="views"><b>View As :</b></label></li>
                                        <li>
                                            <a class="btn-grid" id="grid" href="{{buatLink(URL::current(),array('view'=>'grid'))}}" title="View Grid"></a>
                                        </li>
                                        <li>
                                            <a class="btn-list" id="list" href="{{buatLink(URL::current(),array('view'=>'list'))}}" title="View List"></a>
                                        </li>
                                    </ul>
                                    <div class="clr"></div>
                                </div>
